		...
		{#snippet children()}
			<div class="h-[600px] w-full">
				<div class="h-full p-6">
					...
					<Chat.Root messages={shortConversationMessages} class="h-[500px]" />
				</div>
			</div>
		{/snippet}
	</StoryContainer>
		...
		{#snippet children()}
			<div class="h-[600px] w-full">
				<div class="h-full p-6">
					...
					<Chat.Root messages={mediumConversationMessages} class="h-[500px]" />
				</div>
			</div>
		{/snippet}
	</StoryContainer>
		...
		{#snippet children()}
			<div class="h-[600px] w-full">
				<div class="h-full p-6">
					...
					<Chat.Root messages={longConversationMessages} class="h-[500px]" />
				</div>
			</div>
		{/snippet}
	</StoryContainer>
		...
		{#snippet children()}
			<div class="h-[600px] w-full">
				<div class="h-full p-6">
					...
					<Chat.Root messages={mixedContentMessages} class="h-[500px]" />
				</div>
			</div>
		{/snippet}
	</StoryContainer>
		...
		{#snippet children()}
			<div class="h-[600px] w-full">
				<div class="h-full p-6">
					...
					<Chat.Root messages={interactiveMessages} class="h-[500px]" />
				</div>
			</div>
		{/snippet}
	</StoryContainer>
