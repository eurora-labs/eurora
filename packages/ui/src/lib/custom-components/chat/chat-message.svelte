<script lang="ts" module>
	...
	export const messageVariants = tv({
		base: 'message flex flex-col w-fit items-center gap-2 py-[12px] rounded-2xl overflow-hidden [&_svg:not([class*="size-"])]:size-10 [&_svg]:pointer-events-none [&_svg]:shrink-0',
		variants: {
			variant: {
				default:
