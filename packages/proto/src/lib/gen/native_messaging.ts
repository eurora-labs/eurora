...
export const ProtoNativeYoutubeState: MessageFns<ProtoNativeYoutubeState> = {
	...
	fromJSON(object: any): ProtoNativeYoutubeState {
		return {
			...
			videoFrameBase64: isSet(object.videoFrameBase64)
				? globalThis.String(object.videoFrameBase64)
				: '',
			videoFrameWidth: isSet(object.videoFrameWidth)
				? globalThis.Number(object.videoFrameWidth)
				: 0,
			videoFrameHeight: isSet(object.videoFrameHeight)
				? globalThis.Number(object.videoFrameHeight)
				: 0,
			videoFrameFormat: isSet(object.videoFrameFormat)
				? protoImageFormatFromJSON(object.videoFrameFormat)
				: 0
		};
	},
	...
	create<I extends Exact<DeepPartial<ProtoNativeYoutubeState>, I>>(
		base?: I
	): ProtoNativeYoutubeState {
		return ProtoNativeYoutubeState.fromPartial(base ?? ({} as any));
	},
	fromPartial<I extends Exact<DeepPartial<ProtoNativeYoutubeState>, I>>(
		object: I
	): ProtoNativeYoutubeState {
		const message = createBaseProtoNativeYoutubeState();
