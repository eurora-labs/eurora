//! Common test utilities for euro-focus integration tests
...
fn get_current_focused_window() -> Result<euro_focus::FocusedWindow, Box<dyn std::error::Error>> {
...
#[cfg(target_os = "linux")]
fn get_focused_window_linux() -> Result<euro_focus::FocusedWindow, Box<dyn std::error::Error>> {
    use std::process::Command;
        ...
        .output()
    {
        ...
        return Ok(euro_focus::FocusedWindow {
            process_id: None,
            process_name: None,
...
#[allow(dead_code)]
pub fn get_focused_window() -> euro_focus::FocusedWindow {
    get_current_focused_window().unwrap_or_else(|_| euro_focus::FocusedWindow {
        process_id: None,
        process_name: Some("unknown".to_string()),
        window_title: Some("unknown".to_string()),
        icon: None,
