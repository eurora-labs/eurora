...
This directory contains scripts for setting up headless display environments for testing euro-focus on Linux systems.
...
These scripts are designed to work with the euro-focus integration tests:
