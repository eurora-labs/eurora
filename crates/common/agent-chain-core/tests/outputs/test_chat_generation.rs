...
mod test_chat_generation_chunk {
    ...
    fn test_add_list_of_chunks() {
        ...
        let chunk2 = ChatGenerationChunk::builder()
            ...
            .build();
        let chunk3 = ChatGenerationChunk::builder()
    ...
    fn test_add_list_of_chunks_with_generation_info() {
        let chunk1 = ChatGenerationChunk::builder()
            .message(AIMessage::builder().content("A").build().into())
            .generation_info(HashMap::from([("key1".to_string(), json!("value1"))]))
            .build();
        let chunk2 = ChatGenerationChunk::builder()
            .message(AIMessage::builder().content("B").build().into())
            .generation_info(HashMap::from([("key2".to_string(), json!("value2"))]))
            .build();
        let chunk3 = ChatGenerationChunk::builder()
            .message(AIMessage::builder().content("C").build().into())
            .generation_info(HashMap::from([("key3".to_string(), json!("value3"))]))
            .build();
        let result = merge_chat_generation_chunks(vec![chunk1, chunk2, chunk3]);
        assert!(result.is_some());
        let result = result.unwrap();
    ...
    fn test_merge_multiple_chunks() {
        let chunks = vec![
            ...
            ChatGenerationChunk::builder()
                ...
                .build(),
            ChatGenerationChunk::builder()
                .message(AIMessage::builder().content("D").build().into())
                .build(),
        ];
...
mod test_chat_generation_serialization {
    ...
    fn test_chat_generation_chunk_serialize() {
        let chunk = ChatGenerationChunk::builder()
            .message(AIMessage::builder().content("chunk").build().into())
    ...
    fn test_serialize_deserialize_roundtrip() {
        let chat_gen = ChatGeneration::builder()
            .message(AIMessage::builder().content("roundtrip").build().into())
            .generation_info(HashMap::from([("model".to_string(), json!("gpt-4"))]))
            .build();
    ...
    fn test_chunk_serialize_deserialize_roundtrip() {
        let chunk = ChatGenerationChunk::builder()
            .message(AIMessage::builder().content("chunk_rt").build().into())
            .generation_info(HashMap::from([("key".to_string(), json!("val"))]))
            .build();
...
mod test_chat_generation_chunk_merging_edge_cases {
    ...
    fn test_merge_list_with_mixed_none_generation_info() {
        let chunk1 = ChatGenerationChunk::builder()
            .message(AIMessage::builder().content("A").build().into())
            .generation_info(HashMap::from([("k1".to_string(), json!("v1"))]))
            .build();
        let chunk2 = ChatGenerationChunk::builder()
            .message(AIMessage::builder().content("B").build().into())
            .build();
    ...
    fn test_merge_generation_info_with_int_values() {
        let chunk1 = ChatGenerationChunk::builder()
            .message(AIMessage::builder().content("A").build().into())
            .generation_info(HashMap::from([("tokens".to_string(), json!(10))]))
            .build();
        let chunk2 = ChatGenerationChunk::builder()
            .message(AIMessage::builder().content("B").build().into())
            .generation_info(HashMap::from([("tokens".to_string(), json!(20))]))
            .build();
        let result = chunk1 + chunk2;
        assert!(result.generation_info.is_some());
        let info = result.generation_info.unwrap();
    ...
    fn test_sequential_add_chunks() {
        let c1 = ChatGenerationChunk::builder()
            .message(AIMessage::builder().content("A").build().into())
            .generation_info(HashMap::from([("k1".to_string(), json!("v1"))]))
            .build();
        let c2 = ChatGenerationChunk::builder()
            .message(AIMessage::builder().content("B").build().into())
            .generation_info(HashMap::from([("k2".to_string(), json!("v2"))]))
            .build();
        let c3 = ChatGenerationChunk::builder()
            .message(AIMessage::builder().content("C").build().into())
            .generation_info(HashMap::from([("k3".to_string(), json!("v3"))]))
            .build();
        let result = c1 + c2 + c3;
