...
mod llm_result_tests {
    ...
    fn test_equality_ignores_run_info() {
        ...
        let mut result2 = LLMResult::builder()
            .generations(vec![vec![generation.into()]])
            .build();
    ...
    fn test_empty_generations() {
        let result = LLMResult::builder().generations(vec![]).build();
...
mod llm_result_flatten_tests {
    ...
    fn test_flatten_with_chat_generations() {
        let gen1 = ChatGeneration::builder()
            .message(AIMessage::builder().content("Chat 1").build().into())
            .build();
        let gen2 = ChatGeneration::builder()
            .message(AIMessage::builder().content("Chat 2").build().into())
            .build();
        let mut llm_output = HashMap::new();
...
mod llm_result_equality_tests {
    ...
    fn test_equality_empty_generations() {
        let result1 = LLMResult::builder().generations(vec![]).build();
        let result2 = LLMResult::builder().generations(vec![]).build();
        assert_eq!(result1, result2);
    }
