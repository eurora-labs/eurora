...
impl InMemoryCache {
    ...
    pub fn lookup(&self, prompt: &str, llm_string: &str) -> Option<Vec<String>> {
        self.cache.get(&(prompt.to_string(), llm_string.to_string())).cloned()
    }
...
fn test_local_cache_sync() {
    ...
    assert!(true, "Placeholder for test_local_cache_sync");
}
...
async fn test_local_cache_async() {
    ...
    assert!(true, "Placeholder for test_local_cache_async");
}
...
fn test_global_cache_sync() {
    ...
    assert!(true, "Placeholder for test_global_cache_sync");
}
...
async fn test_global_cache_async() {
    ...
    assert!(true, "Placeholder for test_global_cache_async");
}
...
fn test_no_cache_sync() {
    ...
    assert!(true, "Placeholder for test_no_cache_sync");
}
...
async fn test_no_cache_async() {
    ...
    assert!(true, "Placeholder for test_no_cache_async");
}
...
async fn test_global_cache_abatch() {
    ...
    assert!(true, "Placeholder for test_global_cache_abatch");
}
...
fn test_global_cache_batch() {
    ...
    assert!(true, "Placeholder for test_global_cache_batch");
}
...
fn test_global_cache_stream() {
    ...
    assert!(true, "Placeholder for test_global_cache_stream");
}
...
async fn test_can_swap_caches() {
    ...
    assert!(true, "Placeholder for test_can_swap_caches");
}
...
fn test_llm_representation_for_serializable() {
    ...
    assert!(true, "Placeholder for test_llm_representation_for_serializable");
}
...
fn test_cache_with_generation_objects() {
    ...
    assert!(true, "Placeholder for test_cache_with_generation_objects");
}
...
fn test_cleanup_serialized() {
    ...
    assert!(true, "Placeholder for test_cleanup_serialized");
}
...
fn test_token_costs_are_zeroed_out() {
    ...
    assert!(true, "Placeholder for test_token_costs_are_zeroed_out");
}
