...
pub fn build_specta() -> tauri_specta::Builder<tauri::Wry> {
    tauri_specta::Builder::<tauri::Wry>::new()
        ...
        .commands(tauri_specta::collect_commands![
            ...
            crate::procedures::ask::ask_open_window,
            crate::procedures::ask::ask_close_window,
            crate::procedures::ask::ask_open_answer_window,
            crate::procedures::timeline::timeline_get_current_app,
