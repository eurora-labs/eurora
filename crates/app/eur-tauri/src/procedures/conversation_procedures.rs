use crate::shared_types::{SharedOpenAIClient, SharedPersonalDb, SharedTimeline};
use chrono::Utc;
use eur_personal_db::{ChatMessage, Conversation};
...
pub struct DownloadEvent {
    ...
    pub event_data: DownloadEventData,
}

#[taurpc::ipc_type]
pub enum DownloadEventData {
