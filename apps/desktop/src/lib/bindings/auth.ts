 ...
 */
export type LoginRequest = { kind: "email_password"; login: string; password: string } | { kind: "third_party"; provider: Provider; code: string; state: string; login_token?: string | null };
