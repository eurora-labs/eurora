...
export const commands = {
	authGetLoginToken: () =>
		typedError<LoginToken, AuthError>(__TAURI_INVOKE('auth_get_login_token')),
	...
	authRegister: (email: string, password: string) =>
		typedError<null, AuthError>(__TAURI_INVOKE('auth_register', { email, password })),
	authLogin: (login: string, password: string) =>
		typedError<null, AuthError>(__TAURI_INVOKE('auth_login', { login, password })),
	authLogout: () => typedError<null, AuthError>(__TAURI_INVOKE('auth_logout')),
	authIsAuthenticated: () =>
		typedError<boolean, AuthError>(__TAURI_INVOKE('auth_is_authenticated')),
	authGetAccessTokenPayload: () =>
		typedError<Claims, AuthError>(__TAURI_INVOKE('auth_get_access_token_payload')),
	authRefreshSession: () => typedError<null, AuthError>(__TAURI_INVOKE('auth_refresh_session')),
	authResendVerificationEmail: () =>
		typedError<null, AuthError>(__TAURI_INVOKE('auth_resend_verification_email')),
	...
	paymentCreateCheckoutUrl: () =>
		typedError<string, PaymentError>(__TAURI_INVOKE('payment_create_checkout_url')),
	paymentIsSubscribed: () =>
		typedError<boolean, PaymentError>(__TAURI_INVOKE('payment_is_subscribed')),
