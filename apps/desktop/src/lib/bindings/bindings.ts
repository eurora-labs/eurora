 ...
 */
export type AppBridgeClientStatus = {
	process_name: string,
	connected: boolean,
};
...
"system": {app_bridge_client_status_changed: (status: AppBridgeClientStatus) => Promise<void>, 
...
get_app_bridge_client_count: () => Promise<bigint>, 
...
is_app_bridge_client_connected: (processName: string) => Promise<boolean>, 
