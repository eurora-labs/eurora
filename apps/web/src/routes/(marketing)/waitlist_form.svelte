<script lang="ts">
	...
	let { portalId, formId, submitText = 'Submit', region = 'na1' } = $props();
...
<svelte:head>
	<script src="//js.hsforms.net/forms/embed/v2.js" onload={handleCreateForm}></script>
</svelte:head>

<div id={targetElementID} class="base-hubspot-form"></div>
