...
const ARGS_MAP = { 'auth':'{"auth_state_changed":["claims"],"get_display_name":[],"get_email":[],"get_login_token":[],"get_role":[],"is_authenticated":[],"login":["login","password"],"logout":[],"poll_for_login":[],"refresh_session":[],"register":["email","password"]}', 'chat':'{"cancel_query":["thread_id"],"send_query":["thread_id","channel","query"]}', 'thread':'{"create":[],"delete":["thread_id"],"generate_title":["thread_id"],"get_messages":["thread_id","limit","offset","all_variants"],"list":["limit","offset"],"switch_branch":["thread_id","message_id","direction"]}' }
