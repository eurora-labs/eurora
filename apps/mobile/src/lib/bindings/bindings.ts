...
const ARGS_MAP = { 'auth':'{"auth_state_changed":["claims"],"get_display_name":[],"get_email":[],"get_role":[],"is_authenticated":[],"login":["login","password"],"logout":[],"refresh_session":[],"register":["email","password"],"start_login":[]}', 'chat':'{"cancel_query":["thread_id"],"regenerate":["thread_id","ai_message_id","channel"],"send_query":["thread_id","channel","request"]}', 'thread':'{"create":[],"delete":["thread_id"],"generate_title":["thread_id"],"get_messages":["thread_id","limit","offset"],"list":["limit","offset"],"search_messages":["query","limit","offset"],"search_threads":["query","limit","offset"],"switch_branch":["thread_id","message_id","direction"]}' }
